...
app.post("/edit/:postId",function(req,res){
  const requestedPostId = req.params.postId;
  Post.findOneAndUpdate({_id: requestedPostId}, { $set: { title: req.body.postTitle, content: req.body.postBody }}, 
    function(err,ele){
      res.redirect("/");
    });
});
...
app.get("/edit/:postId",function(req,res){
 ...
 app.get("/delete/:postId", function(req,res){
  const requestedPostId = req.params.postId;
  Post.findOneAndDelete({_id:requestedPostId},function(err,ele){
    if(err){
      console.log(err);
    }
    res.redirect("/");
